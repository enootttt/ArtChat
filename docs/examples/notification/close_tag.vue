...
import type { ArtNotificationOpenArgs } from '@artmate/chat'
import { notification } from '@artmate/chat'
...
const openData: ArtNotificationOpenArgs = {
...
<template>
  <div>
    ...
    <div>
      <ElButton type="primary" :disabled="permission !== 'default'" @click="requestPermission">
        {{
          permission === 'default'
      ...
      <ElButton type="primary" :disabled="permission !== 'granted'" @click="open(openData)">
        Open a notification
      </ElButton>
      <ElButton type="danger" :disabled="permission !== 'granted'" @click="close(['tag_task_completed'])">
        Destroy tag
      </ElButton>
    </div>
  </div>
