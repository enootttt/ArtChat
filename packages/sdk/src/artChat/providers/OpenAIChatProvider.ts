import type { ArtModelMessage, ArtModelParams } from '../../artChat/providers/types/model'
import type { ArtRequestOptions } from '../../artRequest'
import type { SSEFields } from '../../artStream'
...
export default class OpenAIChatProvider<
  ChatMessage extends ArtModelMessage = ArtModelMessage,
  Input extends ArtModelParams = ArtModelParams,
  Output extends Partial<Record<SSEFields, any>> = Partial<Record<SSEFields, any>>,
> extends AbstractChatProvider<ChatMessage, Input, Output> {
  transformParams(requestParams: Partial<Input>, options: ArtRequestOptions<Input, Output>): Input {
    return {
      ...(options?.params || {}),
      ...requestParams,
