...
interface TTableProps extends Record<string, unknown> {
  /** whether it is in head */
  isHead: boolean
}

interface THeadingProps extends Record<string, unknown> {
  /** heading level */
  level: number
}

interface TListProps extends Record<string, unknown> {
  /** depth of the list */
  depth: number
...
interface TCodeProps extends Record<string, unknown> {
